...
const showMessage = (type, title, text, options = {}) => {
  if (isMobile() && !options.forceSwal) {
    ...
    Swal.fire({
      ...
      title: title,
      text: text,
      confirmButtonColor: options.confirmButtonColor || "#8E1C04", // Updated: Red color
          ...
          >
            <div className="flex justify-end">
              <motion.button
                ...
                className="flex items-center gap-2 bg-[#8E1C04] text-white px-4 sm:px-5 py-3 rounded-xl font-semibold shadow-lg hover:shadow-xl hover:bg-[#6d1301] transition-all duration-300 text-sm sm:text-base whitespace-nowrap border border-[#8E1C04]"
              >
                          ...
                          <div className="flex-1 min-w-0">
                            <div className="flex items-center gap-2 sm:gap-3 mb-2 sm:mb-3">
                              <div className="p-2 sm:p-3 bg-gray-100 dark:bg-gray-700 rounded-xl sm:rounded-2xl border border-gray-300 dark:border-gray-500">
                                <FaCity className="text-[#8E1C04] dark:text-[#8E1C04] text-lg sm:text-xl" />
                              </div>
                  ...
                  {filteredCities.length === 0 && (
                    ...
                    >
                      ...
                      <motion.button
                        ...
                        whileTap={{ scale: 0.95 }}
                        onClick={handleAddNewCity}
                        className="flex items-center gap-2 bg-[#8E1C04] text-white px-4 sm:px-6 py-2.5 sm:py-3 rounded-lg sm:rounded-xl font-semibold shadow-lg hover:shadow-xl hover:bg-[#6d1301] transition-all duration-300 text-sm sm:text-base mx-auto border border-[#8E1C04]"
                      >
                ...
                >
                  <div className="bg-white/90 dark:bg-gray-800/90 backdrop-blur-xl rounded-2xl sm:rounded-3xl shadow-xl sm:shadow-2xl p-4 sm:p-5 lg:p-6 border border-gray-300 dark:border-gray-600 sticky top-4 sm:top-6 transition-colors duration-300">
                    <div className="flex items-center justify-between mb-3 sm:mb-4">
                      ...
                      <button
                        onClick={resetForm}
                        className="text-gray-500 hover:text-[#8E1C04] dark:text-gray-400 dark:hover:text-[#8E1C04] transition-colors duration-200 flex-shrink-0 ml-2 border border-gray-300 dark:border-gray-600 p-1 rounded-full"
                      >
                    ...
                    >
                      ...
                      <div>
                        ...
                        <div className="relative group">
                          <FaCity className="absolute left-3 top-1/2 transform -translate-y-1/2 text-[#8E1C04] text-sm transition-all duration-300 group-focus-within:scale-110" />
                          <input
                            type="text"
                            name="name"
                            value={formData.name}
                            ...
                            required
                            className="w-full border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-black dark:text-white rounded-lg sm:rounded-xl pl-9 pr-3 py-2.5 sm:py-3 outline-none focus:ring-2 focus:ring-[#8E1C04] focus:border-transparent transition-all duration-200 text-sm sm:text-base"
                      ...
                      <div className="flex gap-2 sm:gap-3 pt-1 sm:pt-2">
                        ...
                        <motion.button
                          ...
                          className={`flex-1 py-2.5 sm:py-3 rounded-lg sm:rounded-xl font-semibold transition-all duration-300 text-sm sm:text-base flex items-center justify-center gap-1 sm:gap-2 ${
                            isFormValid()
                              ? "bg-[#8E1C04] text-white hover:bg-[#6d1301] hover:shadow-xl cursor-pointer border border-[#8E1C04]"
