  ...
  return (
    ...
    >
      <div className="relative">
        ...
        <div className="absolute inset-0 animate-ping rounded-full h-16 w-16 border-t-4 border-b-4 border-[#8E1C04] opacity-30"></div>
      </div>
      ...
      <motion.button
        ...
        className={`w-full font-semibold py-3.5 rounded-xl transition-all duration-300 text-lg relative overflow-hidden border ${
          resendDisabled
            ...
            : "bg-[#8E1C04] text-white hover:shadow-xl hover:shadow-[#8E1C04]/25 border-[#8E1C04] hover:bg-[#6d1301]"
        }`}
      >
        {resendDisabled
      ...
      <button
        ...
        className="text-[#8E1C04] hover:text-[#6d1301] underline font-medium transition-colors duration-200 text-sm"
      >
