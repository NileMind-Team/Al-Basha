      ...
      <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-xl sm:rounded-2xl p-3 sm:p-4 md:p-5 lg:p-6 border border-gray-200 dark:border-gray-700 shadow-lg sticky top-4 sm:top-6">
        ...
        <form onSubmit={handleSubmit} className="space-y-3 sm:space-y-4">
          <div className="grid grid-cols-1 xs:grid-cols-2 gap-2 sm:gap-3 md:gap-4">
            <div>
              ...
              <div className="relative group" style={{ direction: "ltr" }}>
                <FaUser className="absolute right-3 top-1/2 transform -translate-y-1/2 text-[#8E1C04] text-sm transition-all duration-300 group-focus-within:scale-110" />
                <input
                  type="text"
                  name="firstName"
          ...
          <div>
            ...
            <div className="relative group" style={{ direction: "ltr" }}>
              <FaPhone className="absolute right-3 top-1/2 transform -translate-y-1/2 text-[#8E1C04] text-sm transition-all duration-300 group-focus-within:scale-110" />
              <input
                type="tel"
                name="phoneNumber"
          ...
          <div className="flex gap-2 sm:gap-3 pt-1 sm:pt-2">
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              onClick={resetForm}
              className="flex-1 py-2.5 sm:py-3 border-2 border-[#8E1C04] text-[#8E1C04] rounded-lg sm:rounded-xl font-semibold hover:bg-[#8E1C04] hover:text-white transition-all duration-300 text-sm sm:text-base hover:border-[#6d1301]"
            >
              إلغاء
            </motion.button>
            <motion.button
